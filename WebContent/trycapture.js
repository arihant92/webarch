...
console.log(a1coords);
console.log(a2coords);
...
//console.log("drawing coordinates "+ closest.a[0],closest.a[1],closest.b[0],closest.b[1]);
 ...
 socket.emit('make-path',{ id:drawAggregate.new_id, x1: closest.a[0], y1:closest.a[1] ,x2:closest.b[0],y2: closest.b[1] ,path_type:"aggregate"});
 Mousetrap.bind('command+e', function(e) {
     drawAggregate(closest.a[0],closest.a[1],closest.b[0]-10,closest.b[1]);
 });
